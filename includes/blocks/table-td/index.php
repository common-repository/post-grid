...
class PGBlockTableCell
{
  ...
  {
    register_block_type(
      post_grid_plugin_dir . 'build/blocks/table-td/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    $linkAttr = isset($wrapperOptions["linkAttr"])
      ? $wrapperOptions["linkAttr"]
      : [];
...
$BlockPostGrid = new PGBlockTableCell();
